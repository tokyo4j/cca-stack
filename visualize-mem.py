...
plt.title("2つのVMにおいて、それぞれ1GBのメモリを確保し、KSMでDeduplicate")

plot("data/2025-09-03_15-35-11-ffa737e-ksm", "KSM有効")
plot("data/2025-09-03_17-07-20-ffa737e-ksm-disabled", "KSM無効")
